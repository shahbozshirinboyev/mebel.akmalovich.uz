...
class User(AbstractUser):
    ...
    email = models.EmailField(_("Elektron pochta"), blank=True)
    phone_number = models.CharField(_("Telefon raqam"), max_length=20, blank=True, null=True)
    is_worker = models.BooleanField(_("Ishchi"), default=False, help_text=_("Agar foydalanuvchi ishchi bo'lsa, belgilang."))
    date_joined = models.DateTimeField(_("Ro'yxatga olingan sana"), auto_now_add=True)
